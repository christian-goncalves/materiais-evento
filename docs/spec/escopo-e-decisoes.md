...
- Persistencia para abas: `materiais`, `pedidos`, `pedido_itens`, `estoque`.
- Controle de estoque por movimentacao (`entrada`, `saida`) e estoque baixo.
...
- Nao alterar comportamento fora de persistencia e estoque.
